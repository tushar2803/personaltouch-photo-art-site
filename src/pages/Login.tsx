    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500 mt-2">Sign in to manage your orders</p>
        </div>
        ...
        <div className="mt-8 text-center pt-8 border-t border-zinc-100">
          <p className="text-zinc-500 text-sm">
            Don't have an account? <Link to="/register" className="text-zinc-900 font-bold hover:underline">Create one</Link>
          </p>
        </div>
      </motion.div>
    </div>
